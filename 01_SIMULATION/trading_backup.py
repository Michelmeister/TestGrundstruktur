...
class Handelstabelle(Thread):
    ...
    def read_Handelsstatus(self):
        ...
        # Read Selling_BSS_to
        WE1.Dealing_BSS_with = value[1][3]
        WE2.Dealing_BSS_with = value[2][3]
        WE3.Dealing_BSS_with = value[3][3]
        WE4.Dealing_BSS_with = value[4][3]
        WE5.Dealing_BSS_with = value[5][3]
        WE6.Dealing_BSS_with = value[6][3]
        WE7.Dealing_BSS_with = value[7][3]
        WE8.Dealing_BSS_with = value[8][3]
        WE9.Dealing_BSS_with = value[9][3]
        WE10.Dealing_BSS_with = value[10][3]
        WE11.Dealing_BSS_with = value[11][3]
        WE12.Dealing_BSS_with = value[12][3]
        WE13.Dealing_BSS_with = value[13][3]
        WE14.Dealing_BSS_with = value[14][3]
        WE15.Dealing_BSS_with = value[15][3]
        WE16.Dealing_BSS_with = value[16][3]
        WE17.Dealing_BSS_with = value[17][3]
        WE18.Dealing_BSS_with = value[18][3]
        WE19.Dealing_BSS_with = value[19][3]
        WE20.Dealing_BSS_with = value[20][3]
        WE21.Dealing_BSS_with = value[21][3]
        WE22.Dealing_BSS_with = value[22][3]
        WE23.Dealing_BSS_with = value[23][3]
        WE24.Dealing_BSS_with = value[24][3]
...
class BSS_virtuell(Thread):
    ...
    def set_SOP_BSS(self):
        ...
        if self.SOP_BSS < 1:
            'Selling unit'
            self.E_bat_v_max = BSS.E_bat_max * (SOP_BSS_WEi/24) + 0.1   # +0.1 -> otherwise E_bat_max = E_bat_min when SOP = 0
            self.E_bat_v_min = 0.05 * self.E_bat_v_max
            self.E_trading_surplus = self.E_trading_surplus + self.E_bat_v
            self.E_bat_v = 0
        ...
        if self.SOP_BSS > 1:
            ...
            for WE in Wohneinheiten:
                if WE.Dealing_BSS_with == self.Wohneinheit:
