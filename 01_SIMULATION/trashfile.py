...
class Last_dummy(Thread):
    ...
    def run(self):
        # P_Last später löschen, wird jedoch gerade noch in strategy_ueberschussladen() verwendet
        global P_Last
        P_Last = 0

        # Last je Wohneinheit initialisieren & vorerst auf 0 setzen
        global p_last_we1, p_last_we2, p_last_we3, p_last_we4, p_last_we5, p_last_we6, p_last_we7, p_last_we8, p_last_we9, p_last_we10, p_last_we11, p_last_we12, p_last_we13, p_last_we14, p_last_we15, p_last_we16, p_last_we17, p_last_we18, p_last_we19, p_last_we20, p_last_we21, p_last_we22, p_last_we23, p_last_we24
        p_last_we1 = 0
        p_last_we2 = 0
        p_last_we3 = 0
        p_last_we4 = 0
        ...
        # Last der 24 Wohneinheiten in einer Liste
        p_last_list = [p_last_we1, p_last_we2, p_last_we3, p_last_we4, p_last_we5, p_last_we6, p_last_we7, p_last_we8, p_last_we9, p_last_we10, p_last_we11, p_last_we12, p_last_we13, p_last_we14, p_last_we15, p_last_we16, p_last_we17, p_last_we18, p_last_we19, p_last_we20, p_last_we21, p_last_we22, p_last_we23, p_last_we24]

        # verschiedene csv-Lastprofile öffnen & einer Wohneinheit zuordnen
        # aktuell nur beispielhaft für WE1- WE4 unterschiedliche Lastprofile
        ...
        csv_file_we2 = open('Last_csv\LP17_2010-06-26_06.00.00_to_2010-06-26_23.59.59_Sa.csv',newline='')
        ...
        csv_file_we4 = open('Last_csv\LP17_2010-12-15_06.00.00_to_2010-12-15_23.59.59_Mi.csv',newline='')
        load_profile_we4 = csv.DictReader(csv_file_we4,delimiter=',')
        csv_file_we5 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we5 = csv.DictReader(csv_file_we5,delimiter=',')
        csv_file_we6 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we6 = csv.DictReader(csv_file_we6,delimiter=',')
        csv_file_we7 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we7 = csv.DictReader(csv_file_we7,delimiter=',')
        csv_file_we8 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we8 = csv.DictReader(csv_file_we8,delimiter=',')
        csv_file_we9 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we9 = csv.DictReader(csv_file_we9,delimiter=',')
        csv_file_we10 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we10 = csv.DictReader(csv_file_we10,delimiter=',')
        csv_file_we11 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we11 = csv.DictReader(csv_file_we11,delimiter=',')
        csv_file_we12 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we12 = csv.DictReader(csv_file_we12,delimiter=',')
        csv_file_we13 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we13 = csv.DictReader(csv_file_we13,delimiter=',')
        csv_file_we14 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we14 = csv.DictReader(csv_file_we14,delimiter=',')
        csv_file_we15 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we15 = csv.DictReader(csv_file_we15,delimiter=',')
        csv_file_we16 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we16 = csv.DictReader(csv_file_we16,delimiter=',')
        csv_file_we17 = open('Last_csv\LP17_2010-06-23_04.56.00_to_2010-06-24_21.43.00_Mi.csv',newline='')
        load_profile_we17 = csv.DictReader(csv_file_we17,delimiter=',')
        csv_file_we18 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we18 = csv.DictReader(csv_file_we18,delimiter=',')
        csv_file_we19 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we19 = csv.DictReader(csv_file_we19,delimiter=',')
        csv_file_we20 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we20 = csv.DictReader(csv_file_we20,delimiter=',')
        csv_file_we21 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we21 = csv.DictReader(csv_file_we21,delimiter=',')
        csv_file_we22 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        load_profile_we22 = csv.DictReader(csv_file_we22,delimiter=',')
        csv_file_we23 = open('Last_csv\LP17_2010-06-23_06.00.00_to_2010-06-23_23.59.59_Mi.csv',newline='')
        ...
        # eingelesene Lastprofile in einer Liste
        ...
        # Daten der eingelesenen csv-Dateien werden über die 3 Phasen aufsummiert
...
concurrentthreads = [Participation,PV,Last,BSS,Momentanwerte,WE1,Handel] #,Zeitreihe],PV_excess
